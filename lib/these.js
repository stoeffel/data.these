...
This.prototype.extract = This.prototype.get = function () { return this._this; };
That.prototype.extract = That.prototype.get = function () { return this._that; };
These.prototype.extract = These.prototype.get = function () { return { _this: this._this, _that: this._that }; };

// Comonad : extend

This.prototype.extend = function (f) {
    return new This(f(this));
};

That.prototype.extend = function (f) {
    return new That(f(this));
};

These.prototype.extend = function (f) {
    return new These(f(this), f(this));
};
